...
<center>
<h2>添加新部门</h2><br><br><br>
<form action="addDept.do" onsubmit="return checkDeptForm();" method="post">
<table width="50%" border="0" cellspacing="5" cellpadding="2">
  ...
  <tr>
   <td height="35" align="right">部门名称:</td>
    <td align="left"><input type="text" name="deptName" id="deptName" onblur="checkdeptName();" >
