...
<table width="80%" bgcolor="1" cellspacing="1" cellpadding="1" background="images/5.jpg">
          <tr>
             ...
             <td align="center"><p><a href="selectAllDept?pageNow=1" onclick="return checkupbacklog();">首页</a></p></td>
             <td align="center"><span id="upPage"><a href="selectAllDept?pageNow=${page.pageNow-1 }" onclick="return checkupbacklog();">上一页</a></span></td> 
            <td align="center"><p><a href="selectAllDept?pageNow=${page.pageNow+1 }" onclick="return checklastbacklog();">下一页</a></p></td>
             <td align="center"><p><a href="selectAllDept?pageNow=${page.pageCount }" onclick="return checklastbacklog();">尾页</a></p></td> 
