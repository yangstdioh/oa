...
<center>
<h2>添加待办事项</h2><br><br><br>
<form action="addBackLog.do" onsubmit="return checkbackLogForm();" method="post">
<table width="50%" border="0" cellspacing="5" cellpadding="2">
  ...
  <td><input type="text" readonly="readonly" name="date" id="date" onblur="checkdate();">
  <span id="datemes" style="color: red;"></span></td>
  </tr>
  <tr>
  <td width="35%" height="35" align="right">待办事项:</td>
  <td><textarea rows="5" cols="30" name="backlog" id="backlog" onblur="checkbacklog();"></textarea>
