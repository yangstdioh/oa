...
<body topmargin="0" >
  ...
  <tr>
    ...
    <!-- 引入右部页面 -->
    <td width="88%" align="center"  background="images/5.jpg" style="background-repeat:repeat-x;"><jsp:include flush='true' page="../userpages/SendMessage.jsp"/></td>
  </tr>
</table>
</body>
...
function checkmessage(){
	if ($("#message")[0].value.replace(/(^\s*)|(\s*$)/g, "").length == 0) {
		$("#messagemes")[0].innerHTML = "信息不能为空";
		return false;
	} else {
	    	  $("#messagemes")[0].innerHTML = "";
	          return true;
	}
}
//判断联系人是否为空
function checkreceiverId(){
	var receiver = $("#receiverId")[0].value;
	if(receiver=="--请选择--"){
		$("#receivermes")[0].innerHTML = "请选择联系人";
		return false;
	} else {
	    $("#receivermes")[0].innerHTML = "";
	    return true;
	}
