...
<table width="50%" border="0" cellspacing="5" cellpadding="2">
  <tr>
    ...
    <input type="text" name="username" id="username" onblur="checkusername();" value="${user.username }">
    <span id="usernamemes" style="color: red;">${usernamemes}</span></td>
  </tr>
  <tr>
   <td height="35" align="right">密&nbsp;码:</td>
    <td align="left"><input type="password" name="password" id="password" onblur="checkpassword();" value="${user.password }">
    <span id="passwordmes" style="color: red;"></span></td>
  </tr>
  <tr>
   <td height="35" align="right">真实姓名:</td>
    <td align="left"><input type="text" name="realname" id="realname" onblur="checkrealname();" value="${user.realname }">
  ...
  <tr>
   <td height="35" align="right">年&nbsp;龄:</td>
    <td align="left"><input type="text" name="age" id="age" onblur="checkage();" value="${user.age }">
