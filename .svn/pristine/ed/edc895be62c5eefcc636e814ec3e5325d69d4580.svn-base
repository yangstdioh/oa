...
<center>
<h2>发布新公告</h2><br><br><br>
<form action="AddCompanyAnnounce.do" onsubmit="return checkPublishForm();" method="post">
<table width="50%" border="0" cellspacing="5" cellpadding="2">
  ...
  <td><textarea name="content" id="content" rows="16" cols="40" onblur="checkContent();"></textarea>
  <span id="contentmes" style="color: red;"></span></td>
  </tr>
   <tr>
    <td width="35%" height="35" align="right"></td>
    <td width="68%" align="left">
    <input type="hidden" name="publish" value="${sessionScope.admin}">
    </td>
  </tr>
